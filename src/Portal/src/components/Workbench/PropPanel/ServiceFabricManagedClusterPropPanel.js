...
export default class ServiceFabricManagedClusterPropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new ServiceFabricManagedCluster(),
  ...
  render = () => {
    return (
      <Drawer
          title="Service Fabric Managed Cluster Properties"
          autoFocus= {true}
