...
export default class TimeSeriesInsightsEventSourcePropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new TimeSeriesInsightsEventSource(),
  ...
  render = () => {
    return (
      <Drawer
          title="Time Series Insights Event Source Properties"
          autoFocus= {true}
