...
export default class ProximityPlacementGroupPropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new ProximityPlacementGroup(),
  ...
  render = () => {
    return (
      <Drawer
          title="Proximity Placement Group Properties"
          autoFocus= {true}
