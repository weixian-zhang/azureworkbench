...
export default class LogicAppCustomConnectorPropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new LogicAppCustomConnector(),
  ...
  render = () => {
    return (
      <Drawer
          title="Logic App Custom Connector Properties"
          autoFocus= {true}
