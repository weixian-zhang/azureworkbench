...
export default class MLServiceWorkspacePropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new MLServiceWorkspace(), //default to blob, but can be Table,Queue,AzFile
        value: 'diagram', //tabs
