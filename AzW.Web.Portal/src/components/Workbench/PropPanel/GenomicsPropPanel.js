...
export default class GenomicsPropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new Genomics(), //default to blob, but can be Table,Queue,AzFile
        value: 'diagram', //tabs
