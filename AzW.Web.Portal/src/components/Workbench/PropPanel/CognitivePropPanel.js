...
export default class CognitivePropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new Cognitive(), //default to blob, but can be Table,Queue,AzFile
        value: 'diagram', //tabs
