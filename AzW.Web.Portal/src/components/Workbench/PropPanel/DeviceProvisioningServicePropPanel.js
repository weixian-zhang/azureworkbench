...
export default class DeviceProvisioningServicePropPanel extends Component {
  constructor(props) {
      super(props);

      this.state ={
        isOpen: false,
        userObject: new DeviceProvisioningService(),
  ...
  render = () => {
    return (
      <Drawer
          title="Device Provisioning Service Properties"
          autoFocus= {true}
